...
class GpsTrackRepositoryImplTest {
    ...
    private val mockGpsTrackDao = mockk<GpsTrackDao>()
    private val mockGpsPointDao = mockk<GpsPointDao>()
    ...
    fun setup() {
        ...
        repository = GpsTrackRepositoryImpl(mockGpsTrackDao, mockGpsPointDao)
    }
